...
const AuthScreen = ({ onAuthSuccess }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#d4f0f0] via-[#e0f6f8] to-[#cbf0f8] p-4 relative overflow-hidden">
      {/* Ambient background glows */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-cyan-400/20 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-teal-300/30 rounded-full blur-[100px] pointer-events-none" />
